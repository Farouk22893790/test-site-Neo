...
public class PageNeoMobile {
    ...
    public static final UrlElement url2 = new UrlElement("neo mobile url", "/neo-mobile/");

    // à changé avec Manel sur gitlab
    ...
    public static final BlockElement horizontalFrame =new BlockElement("cadre au milieu de la page neo.mobile",
